...
insert into users (id, username, email, password, created, created_by, modified, modified_by)
values ('1c56e6eb-c0eb-46a6-a4b7-acd770d08c77', 'Test','email01@gmail.com', '123456',
        now(), 'MIGRATION|2024-02-25-008-creating-portfolio-distribution.sql',
        now(), 'MIGRATION|2024-02-25-008-creating-portfolio-distribution.sql');

insert into portfolio (id, name, symbol, creation_date, created, created_by, modified, modified_by, user_id)
values ('1c56e6eb-c0eb-46a6-a4a6-acd770d08c88', 'Test','Test', '2024-02-26 02:37:34',
        now(), 'MIGRATION|2024-02-25-008-creating-portfolio-distribution.sql',
        now(), 'MIGRATION|2024-02-25-008-creating-portfolio-distribution.sql',
        '1c56e6eb-c0eb-46a6-a4b7-acd770d08c77');

INSERT INTO transactions (date_utc, side, pair, symbol, paid_with, fee, fee_symbol, created, created_by, modified, modified_by, price, paid_amount, fee_amount, executed, portfolio_id)
